...
//    NSManagedObjectContext *context = [appDelegate managedObjectContext];
//    
//    obj = [self insertPaintSwatch:(PaintSwatches *)obj context:context];
//    obj = [self insertMixAssociation:(PaintSwatches *)obj context:context];
//
//    NSError *error;
//    if (![context save:&error]) {
//        NSLog(@"Can't Save! %@ %@", error, [error localizedDescription]);
...
//}
//
//+ (PaintSwatches *)insertPaintSwatch:(PaintSwatches *)obj context:(NSManagedObjectContext *)context {
//    
//    NSManagedObject *insert = [NSEntityDescription insertNewObjectForEntityForName:@"PaintSwatches" inManagedObjectContext:context];
//    
//    // Replaced (see below)
//    //
//    //    NSManagedObjectID *uidObj = [insert objectID];
//    //    NSInteger uid = (NSInteger)uidObj;
//    //    [insert setValue:[NSNumber numberWithUnsignedLongLong:uid] forKey:@"uid"];
//    
//    int uid = [self getUID];
//    
//    [insert setValue:[NSNumber numberWithInt:uid] forKey:@"uid"];
...
//    [obj setUid:uid];
//    
//    BOOL is_mix = obj.is_mix;
//    
//    [insert setValue:obj.name                                 forKey:@"name"];
//    [insert setValue:[NSDate date]                            forKey:@"create_date"];
//    [insert setValue:[NSDate date]                            forKey:@"last_update"];
//    
//    
//    [insert setValue:[NSString stringWithFormat:@"%.2f", obj.red] forKey:@"red"];
//    [insert setValue:[NSString stringWithFormat:@"%.2f", obj.grn] forKey:@"green"];
//    [insert setValue:[NSString stringWithFormat:@"%.2f", obj.blu] forKey:@"blue"];
//    [insert setValue:[NSString stringWithFormat:@"%.4f", obj.hue] forKey:@"hue"];
//    [insert setValue:[NSString stringWithFormat:@"%.4f", obj.sat] forKey:@"saturation"];
//    [insert setValue:[NSString stringWithFormat:@"%.4f", obj.bri] forKey:@"brightness"];
//    
//    int deg_hue = (int)(obj.hue * 360);
//    [insert setValue:[NSNumber numberWithInteger:deg_hue]     forKey:@"deg_hue"];
//    
//    [insert setValue:[NSNumber numberWithBool:is_mix] forKey:@"is_mix"];
//    
//    int type_id = obj.type_id;
//    [insert setValue:[NSNumber numberWithInt:type_id]  forKey:@"type_id"];
//    
//    
//    // Save the image as Transformable
//    //
//    NSData *imageData = [NSData dataWithData:UIImagePNGRepresentation(obj.image_thumb)];
//    [insert setValue:imageData forKey:@"image_thumb"];
//    
//    // To be set
//    //
//    [insert setValue:@""                                      forKey:@"abbr_name"];
//    [insert setValue:@""                                      forKey:@"desc"];
//    [insert setValue:@""                                      forKey:@"image_url"];
//    [insert setValue:[NSNumber numberWithInteger:0]           forKey:@"ref_source_id"];
//    
//    return obj;
//}
